...
/**
 * Modern loan account entity with proper Java types and JPA relationships.
 * Migrated from: CDW_LN_ACCT (legacy Access/H2 denormalized all-VARCHAR table)
 *
 * Key improvements:
 * - Normalized: borrower data accessed via FK instead of denormalized columns
 * - Proper types: BigDecimal for amounts, LocalDate for dates, Integer for counts
 * - JPA relationships: @ManyToOne for borrower and product
 */
@Entity
